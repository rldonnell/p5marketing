...
export default async function BlogPost({ params }) {
  ...
  return (
    <main className="p5-main">
      ...
      {/* ── Light-themed article container ── */}
      <div className="p5-blog-article-light">
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1
            ...
            style={{ fontSize: '2.2rem', marginTop: '.75rem', color: 'var(--p5-text)' }}
        ...
        {/* ── Featured image ── */}
        {image && (
          <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 0 2rem' }}>
            <img
              src={image}
