...
export const visitorIdPageContent = {
  seo: {
    title: "Website Visitor Identification Software | VisitorID\u2122 by P5 Marketing",
    description:
      "VisitorID\u2122 is website visitor identification software that recovers anonymous visitors before they disappear. Identify website visitors, score intent, and deliver qualified leads to your CRM automatically.",
  },
  ...
  productScreenshots: {
    ...
    screens: [
      ...
      },
      {
        ...
        caption: "Deep visitor profiles with demographics, financial data, intent signals, and page-level browsing history",
      },
    ],
  },
