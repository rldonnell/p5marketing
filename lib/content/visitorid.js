...
export const visitorIdPageContent = {
  seo: {
    ...
    description:
      "VisitorID\u2122 identifies up to 60% of anonymous website visitors by name, email, and phone. Score intent and deliver qualified leads to your CRM automatically.",
  },
