...
export const visitorIdPageContent = {
  seo: {
    ...
    description:
      "VisitorID\u2122 identifies up to 60% of anonymous website visitors by name, email, phone, address, and household income \u2014 then scores buying intent and routes the serious ones to your CRM automatically. Built into every P5 engagement.",
  },
