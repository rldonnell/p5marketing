...
/**
 * Local image manifest — maps post slugs to locally-served image paths.
 * Updated by scripts/download-wp-images.mjs; safe to edit by hand.
 */
const IMAGE_MANIFEST = {
  'your-website-should-be-built-by-something-that-already-knows-your-business':
    '/blog-images/your-website-should-be-built-by-something-that-already-knows-your-business.webp',
};
...
export function getFeaturedImage(post) {
  if (post?.slug && IMAGE_MANIFEST[post.slug]) {
    return IMAGE_MANIFEST[post.slug];
  }
